...
st.header('Teachers_Attendance_Report')
...
if logs_list:
    ...
    tab1, tab2, tab3 = st.tabs(['Registered Students', 'Logs', 'Attendence-Report'])
    ...
    with tab1:
        if st.button('Refresh Data'):
            ...
            with st.spinner('Retriving data from Redis db...'):
                ...
                student_data = redis_face_db[redis_face_db['Role'] == 'Teacher']
    ...
    # Main app
        with st.container():
            ...
            logs_df = logs_df[logs_df['Role'] == 'Teacher']
            ...
            if report_type == "Daily":
                ...
                report_df = report_df[['Date', 'Name', 'Status', 'In_time', 'Out_time', 'Duration_hrs']]
